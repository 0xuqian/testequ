...
const nonBnbPools = poolsConfig.filter((pool) => pool.stakingToken.symbol !== 'BNB' && pool.stakingToken.symbol !== 'ETH')
const bnbPools = poolsConfig.filter((pool) => pool.stakingToken.symbol === 'BNB' || pool.stakingToken.symbol === 'ETH')
